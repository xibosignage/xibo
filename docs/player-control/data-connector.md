...
This guide will walk you through the steps to create a Data Connector that is supplied via a connector.

## Step-by-Step Implementation Guide
This feature allows connectors to provide predefined JavaScript. The process is divided into two parts:
